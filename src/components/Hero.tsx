...
const Hero = () => {
  ...
  const clientsCount = useCountAnimation(500);
  const yearsCount = useCountAnimation(8);
  const successCount = useCountAnimation(95);
    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div ref={imageRef as any} className={`relative flex justify-center items-center transition-all duration-1000 ${isImageVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
